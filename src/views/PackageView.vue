...
<div><div style="display: inline-flex;">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 490.076 490.076" style="height:50px;margin:auto;margin-bottom: 1.5rem;enable-background:new 0 0 490.076 490.076;" xml:space="preserve">
      <g>
    ...
    <h1>New Package Info</h1>
  </div>
  <div>A parcel is waiting for you at your neighbor: <strong>Wieland</strong></div>
  <button>mark as 'retrieved'</button>
</div>
